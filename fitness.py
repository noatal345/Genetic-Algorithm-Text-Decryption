...
# 1. dictionary_fitness: search the number of word from file that appear in the dictonary
...
def dictionary_fitness(file, dictionary):
    fitness = 0
    # open the file
...
def letter_frequency_fitness(file, english_letter_frequency):
    ...
    return fitness/len(file_letter_frequency)
...
def two_letter_frequency_fitness(file, english_2letter_frequency):
    ...
    with open(file, 'r') as f:
        ...
        file_2letter_frequency = {two_letter: count / total_count for two_letter, count in file_2letter_frequency.items()}
        # compare the letter frequency of the file to the letter frequency of the english language
    ...
    return fitness/len(file_2letter_frequency)
